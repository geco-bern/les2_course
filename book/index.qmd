...
Students hand in the report of the self-guided project, building on completed exercises, and submitted in the form of a reproducible workflow (code repository). See [Logistics](@sec-logistics) for more information.
...
This course is a product of the group for [Geocomputation and Earth Observation](https://geco-group.org/), Institute of Geography with contributions by Dr. Koen Hufkens and Pascal Schneider.
