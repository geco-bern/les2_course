...
This course is a lecture, taught at the University of Bern in the Masters program for *Geography* and for *Climate Sciences* students. It follows the [online textbook Land in the Earth System](https://geco-bern.github.io/les/).
...
Master students in Geography and Climate Science. Contents of Land in the Earth System 1 (LES 1) are the basis. Students that did not take LES 1 are expected to learn its contents through self-study prior to the start of LES 2 using the [online textbook Land in the Earth System](https://geco-bern.github.io/les/).

-------

The lead for this course is by by Prof. [Benjamin Stocker](https://geco-group.org/author/benjamin-stocker/) and co-taught with [Dr. Fabian Bernhard](https://geco-group.org/author/fabian-bernhard/) and [Dr. Fabrice Lacroix](https://geco-group.org/author/fabrice-lacroix/). The website is a product of the group for [Geocomputation and Earth Observation](https://geco-group.org/), Institute of Geography, University of Bern. 
